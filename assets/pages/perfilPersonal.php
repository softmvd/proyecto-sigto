...
if (!isset($_SESSION['usuario'])) {
    header("Location: /proyecto-sigto/assets/pages/login.php"); // Redirigir al login si no ha iniciado sesión
    exit();
}
...
<header>
    ...
    <div class="menu-primero">
        ...
        <div>
            <a href="perfilPersonal.php">Mi Cuenta</a>
        </div>
        <div>
        ...
        <section class="info">
            ...
            <div class="container-contenido">
                ...
                <div>    
                    ...
                    <div class="form">
                        <div>
                            <p>Telefono: <?php echo $cuenta["telefono"] ?></p>
                        </div>
                        <div>
                            <p>Genero:<?php echo $cuenta["genero"] ?></p=>
                        </div>
                        <div>
                            <p>Fecha naciemiento:<?php echo $cuenta["fechaNac"] ?></p=>
                        </div>
