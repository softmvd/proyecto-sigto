...
<header>
    ...
    <main>
        ...
        <article class="container-info">
            <section class="info">
                <div class="container-contenido">
                    <div><img src="/proyecto-sigto/assets/img/info-personal.png" alt="logo-perfil"></div>
                    <div>    
                        <h3>Tu informacion</h3>
                        <p>La informacion que completas para usar tu cuenta.</p>
                    </div>
                    <div>
                ...
                <div class="container-contenido">
                    <div><img src="/proyecto-sigto/assets/img/seguridad.png" alt="seguridad"></div>
                    <div>    
                        <h3>Seguridad</h3>
